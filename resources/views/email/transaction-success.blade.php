                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    style="font-family:Playfair Display, Times New Roman, serif;font-size:25px;font-weight:bold;line-height:1;text-align:center;color:#071c4d;">
                                                    Don't Forget Yout E-Ticket</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:550px;">
                                                                <img alt=""
                                                                    src="{{ url($data->travel_package->galleries->first()->image) }}"
                                                                    style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;"
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td
                                                style="border-bottom:1px dashed #eee;vertical-align:top;padding-bottom:30px;">
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    kamu sudah
                                                                    berhasil dicetak. <br> Booking ID
                                                            ...
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;"> {{ $data->travel_package->title }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                            ...
                                                            <td align="left"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: right;">42475684356</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Send a transfer note to <a href="https://wa.me/628758901426">087758901426</a></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" bgcolor="#ff9e53"
                                                                                ...
                                                                                <a href="{{ url('checkout/' . $data->id) }}"
                                                                                    style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                                                                    Check Detail</a>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td style="width: 50px;">
                                                            <mj-text>Butuh Bantuan ?</mj-text>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 50px;">
                                                            <mj-text>087758901426</mj-text>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 50px;">
                                                            <mj-text>suport@madstrav.id</mj-text>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    2023 MADSTRAV All Right Reserved.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
